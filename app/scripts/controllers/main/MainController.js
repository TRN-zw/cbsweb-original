    ...
    mifosX.controllers = _.extend(module, {
        MainController: function (scope, location, sessionManager, translate, $rootScope, localStorageService, keyboardManager, $idle, tmhDynamicLocale,
            ...
            $rootScope.hasPermission = function (permission) {
                ...
                //FYI: getting all permissions from local storage, because if scope changes permissions array will become undefined
            ...
            scope.$on("UserAuthenticationSuccessEvent", function (event, data) {
                ...
                if (sessionManager.get(data)) {
                    ...
                    location.path('/richdashboard').replace();
                } else {
            ...
            scope.text = 'Powered By <a href ="http://www.mopane.co.zw">Mopane Systems</a>';
            ...
            var addrmodels = ['/users/','/organization','/system','/products','/templates', '', '/accounting','/branches','/loans',
