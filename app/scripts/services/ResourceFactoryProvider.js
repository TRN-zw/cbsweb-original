(function (module) {
    mifosX.services = _.extend(module, {
        ResourceFactoryProvider: function () {
            var baseUrl = "https://mopane.mopane.co.zw/" , apiVer = "/fineract-provider/api/v1", tenantIdentifier = "";
            ...
            this.$get = ['$resource', '$rootScope', function (resource, $rootScope) {
                ...
                return {
                    ...
                    loanResource: defineResource(apiVer + "/loans/:loanId/:resourceType/:resourceId", {resourceType: '@resourceType', loanId: '@loanId', resourceId: '@resourceId', limit: '@limit', sqlSearch: '@sqlSearch'}, {
                        getAllLoans: {method: 'GET', params: {limit:'@limit'}},
                        getAllNotes: {method: 'GET', params: {}, isArray: true},
                        put: {method: 'PUT', params: {}}
                    }),
                    loansResource: defineResource(apiVer + "/loans/",{}, {
                      getAllLoansList: {method: 'GET', params:{}}
                    }),
                    transactionResource: defineResource(apiVer + "/loans/transactions",{}, {
                      getAllTransactions: {method: 'GET', params:{}}
                    }),
